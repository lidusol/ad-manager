import { Injectable, InjectionToken, TemplateRef, Component, ChangeDetectionStrategy, ApplicationRef, ElementRef, ChangeDetectorRef, Renderer2, ViewChild, ViewContainerRef, Injector, ComponentFactoryResolver, Directive, NgModule } from '@angular/core';
import { LyOverlayRef, shadowBuilder, st2c, StyleCollection, StyleRenderer, LyTheme2, STYLES_BACKDROP_DARK, createStyle, LyStyle, LyOverlay, LyCommonModule, LyOverlayModule } from '@alyle/ui';
...
LyDialogModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyDialogModule_Factory(t) { return new (t || LyDialogModule)(); }, providers: [
        ...
        LyCommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyDialogModule, { declarations: function () { return [LyDialogContainer,
        LyDialogTitle,
        LyDialogContent,
        LyDialogActions]; }, imports: function () { return [CommonModule,
        LyCommonModule,
        LyOverlayModule]; }, exports: function () { return [LyCommonModule,
        LyDialogContainer,
        LyDialogTitle,
        LyDialogContent,
        LyDialogActions]; } }); })();
