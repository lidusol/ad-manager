import { LyStyleUtils, Dir, StyleCollection, shadowBuilder, LyTheme2, LY_THEME_NAME, mergeThemes } from '@alyle/ui';
...
MinimaBase.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaBase, factory: MinimaBase.ɵfac });
...
ThemeMinimaLight.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ThemeMinimaLight, selectors: [["", "ly-theme-minima-light", ""]], features: [ɵngcc0.ɵɵProvidersFeature([LyTheme2, { provide: LY_THEME_NAME, useValue: 'minima-light' }])] });
...
ThemeMinimaDark.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ThemeMinimaDark, selectors: [["", "ly-theme-minima-dark", ""]], features: [ɵngcc0.ɵɵProvidersFeature([LyTheme2, { provide: LY_THEME_NAME, useValue: 'minima-dark' }])] });
...
ThemeMinimaModule.ctorParameters = () => [];
...
MinimaDeepDark.ɵfac = function MinimaDeepDark_Factory(t) { return ɵMinimaDeepDark_BaseFactory(t || MinimaDeepDark); };
MinimaDeepDark.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaDeepDark, factory: MinimaDeepDark.ɵfac });
const ɵMinimaDeepDark_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(MinimaDeepDark);
