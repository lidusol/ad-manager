...
import { InjectionToken, isDevMode, ViewEncapsulation, ɵɵdefineInjectable, ɵɵinject, RendererFactory2, Injectable, Inject, Optional, NgZone, Directive, ViewContainerRef, Input, NgModule, ElementRef, Renderer2, Component, HostListener, Injector, TemplateRef, ComponentFactoryResolver, ApplicationRef, ChangeDetectionStrategy } from '@angular/core';
...
const getThemeNameForSelectors = memoize(ɵ0);

const LINE_FEED_REGEX = () => /(\n?[^\n]+\n?)/g;
const ɵ0$1 = LINE_FEED_REGEX;
 ...
 */
const parseMediaQueryFromString = memoize(ɵ0$2);
const ɵ1$1 = (key) => {
    return key.split(' ');
};
/**
 ...
 */
const parseMediaQueriesFromString = memoize(ɵ1$1);
/**
...
CoreTheme.ɵprov = ɵɵdefineInjectable({ factory: function CoreTheme_Factory() { return new CoreTheme(ɵɵinject(RendererFactory2), ɵɵinject(DOCUMENT), ɵɵinject(Platform$1), ɵɵinject(LY_CLASS_NAME_PREFIX, 8)); }, token: CoreTheme, providedIn: "root" });
...
StylesInDocument.ɵprov = ɵɵdefineInjectable({ factory: function StylesInDocument_Factory() { return new StylesInDocument(); }, token: StylesInDocument, providedIn: "root" });
...
LyCoreStyles.ɵfac = function LyCoreStyles_Factory(t) { return new (t || LyCoreStyles)(ɵngcc0.ɵɵinject(LyTheme2)); };
LyCoreStyles.ɵprov = ɵɵdefineInjectable({ factory: function LyCoreStyles_Factory() { return new LyCoreStyles(ɵɵinject(LyTheme2)); }, token: LyCoreStyles, providedIn: "root" });
...
LyRippleService.ɵprov = ɵɵdefineInjectable({ factory: function LyRippleService_Factory() { return new LyRippleService(ɵɵinject(LyTheme2)); }, token: LyRippleService, providedIn: "root" });
...
LyWithClass.ɵfac = function LyWithClass_Factory(t) { return new (t || LyWithClass)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
LyWithClass.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LyWithClass, selectors: [["", "withClass", ""]], inputs: { withClass: "withClass" } });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyCoreStyles, [{
        type: Injectable,
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyWithClass, [{
        type: Directive,
        args: [{
                selector: '[withClass]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }]; }, { withClass: [{
            type: Input
        }] }); })();
...
LyCommonModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyCommonModule });
LyCommonModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyCommonModule_Factory(t) { return new (t || LyCommonModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyCommonModule, { declarations: [LyStyle,
        LyWithClass,
        LyPaper], exports: [LyStyle,
        LyWithClass,
        LyPaper] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyCommonModule, [{
        type: NgModule,
        args: [{
...
LyStyleDeprecatedModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyStyleDeprecatedModule });
LyStyleDeprecatedModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyStyleDeprecatedModule_Factory(t) { return new (t || LyStyleDeprecatedModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyStyleDeprecatedModule, { declarations: [LyStyleDeprecated], exports: [LyStyleDeprecated] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyStyleDeprecatedModule, [{
        type: NgModule,
        args: [{
...
LyFocusState.ɵprov = ɵɵdefineInjectable({ factory: function LyFocusState_Factory() { return new LyFocusState(ɵɵinject(NgZone), ɵɵinject(Platform$1)); }, token: LyFocusState, providedIn: "root" });
...
const AUI_LAST_UPDATE = '2021-01-20T00:15:41.465Z';
...
LyThemeModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyThemeModule });
LyThemeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyThemeModule_Factory(t) { return new (t || LyThemeModule)(); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyThemeModule, [{
        type: NgModule
    }], null, null); })();
...
LyOverlayContainer.ɵprov = ɵɵdefineInjectable({ factory: function LyOverlayContainer_Factory() { return new LyOverlayContainer(ɵɵinject(LyTheme2), ɵɵinject(Platform$1)); }, token: LyOverlayContainer, providedIn: "root" });
...
const STYLES_BACKDROP_ROOT = () => (className) => `${st2c((LY_COMMON_STYLES.fill), `${className}`)}${className}{width:100vw;height:100vh;pointer-events:all;user-select:none;}`;
...
LyOverlay.ɵfac = function LyOverlay_Factory(t) { return new (t || LyOverlay)(ɵngcc0.ɵɵinject(LyOverlayContainer), ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(ɵngcc0.ApplicationRef), ɵngcc0.ɵɵinject(ɵngcc0.Injector), ɵngcc0.ɵɵinject(ɵngcc2.ScrollDispatcher), ɵngcc0.ɵɵinject(ɵngcc2.ViewportRuler)); };
LyOverlay.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: LyOverlay, factory: LyOverlay.ɵfac });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyOverlay, [{
        type: Injectable
    }], function () { return [{ type: LyOverlayContainer }, { type: ɵngcc0.ComponentFactoryResolver }, { type: ɵngcc0.ApplicationRef }, { type: ɵngcc0.Injector }, { type: ɵngcc2.ScrollDispatcher }, { type: ɵngcc2.ViewportRuler }]; }, null); })();

class LyOverlayModule {
}
LyOverlayModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyOverlayModule });
LyOverlayModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyOverlayModule_Factory(t) { return new (t || LyOverlayModule)(); }, providers: [
        LyOverlay
    ] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyOverlayModule, { declarations: [LyOverlayBackdrop] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyOverlayModule, [{
        type: NgModule,
        args: [{
...
ElementObserver.ɵprov = ɵɵdefineInjectable({ factory: function ElementObserver_Factory() { return new ElementObserver(ɵɵinject(MutationObserverFactory)); }, token: ElementObserver, providedIn: "root" });
...
WinResize.ɵprov = ɵɵdefineInjectable({ factory: function WinResize_Factory() { return new WinResize(ɵɵinject(DOCUMENT), ɵɵinject(NgZone)); }, token: WinResize, providedIn: "root" });
...
WinScroll.ɵprov = ɵɵdefineInjectable({ factory: function WinScroll_Factory() { return new WinScroll(ɵɵinject(DOCUMENT), ɵɵinject(NgZone)); }, token: WinScroll, providedIn: "root" });
...
LyExpansionIconModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyExpansionIconModule });
LyExpansionIconModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyExpansionIconModule_Factory(t) { return new (t || LyExpansionIconModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyExpansionIconModule, { declarations: [LyExpansionIcon], exports: [LyExpansionIcon] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyExpansionIconModule, [{
        type: NgModule,
        args: [{
...
export { AUI_LAST_UPDATE, AUI_VERSION, AlignAlias, CoreTheme, Dir, DirAlias, DirPosition, ElementObserver, FocusStatus, IS_CORE_THEME, LY_CLASS_NAME_PREFIX, LY_COMMON_STYLES, LY_COMMON_STYLES_DEPRECATED, LY_HAMMER_OPTIONS, LY_THEME, LY_THEME_GLOBAL_VARIABLES, LY_THEME_NAME, LyCommonModule, LyCoreStyles, LyExpansionIcon, LyExpansionIconModule, LyFocusState, LyHammerGestureConfig, LyHostClass, LyOverlay, LyOverlayBackdrop, LyOverlayConfig, LyOverlayContainer, LyOverlayModule, LyOverlayPosition, LyOverlayRef, LyPaper, LyPaperBase, LyPaperMixinBase, LyRippleService, LySelectionModel, LyStyle, LyStyleDeprecated, LyStyleDeprecatedModule, LyStyleUtils, LyTheme2, LyThemeModule, LylParse, MutationObserverFactory, NgTranscludeDirective, NgTranscludeModule, OverlayFactory, Platform, Positioning, Ripple, STYLES_BACKDROP_DARK, STYLES_BACKDROP_ROOT, Shadows, StringIdGenerator, Style, StyleCollection, StyleRenderer, StylesInDocument, THEME_VARIABLES, TypeStyle, Undefined, UndefinedValue, WinResize, WinScroll, XPosition, YPosition, _STYLE_MAP, _renderStyle, capitalizeFirstLetter, converterToCssKeyAndStyle, createOverlayInjector, createStyle, defaultEntry, eachMedia, getContrastYIQ, getLyThemeStyleUndefinedError, getLyThemeVariableOptionUndefinedError, getLyThemeVariableUndefinedError, getNativeElement, getThemeNameForSelectors, invertPlacement, keyframesUniqueId, lyl, memoize, mergeDeep, mergeThemes, mixinBg, mixinColor, mixinDisableRipple, mixinDisabled, mixinElevation, mixinOutlined, mixinRaised, mixinShadowColor, mixinStyleUpdater, mixinTabIndex, parseMediaQueriesFromString, parseMediaQueryFromString, scrollTo, scrollWithAnimation, shadowBuilder, st2c, supportsPassiveEventListeners, toBoolean, toNumber, untilComponentDestroyed, withMediaInline, ɵ0$4 as ɵ0, ɵ1$3 as ɵ1, ɵ10, ɵ11, ɵ12, ɵ13, ɵ14, ɵ15, ɵ16, ɵ17, ɵ18, ɵ19, ɵ2$2 as ɵ2, ɵ20, ɵ21, ɵ22, ɵ23, ɵ24, ɵ25, ɵ26, ɵ27, ɵ28, ɵ29, ɵ3, ɵ30, ɵ31, ɵ32, ɵ33, ɵ34, ɵ35, ɵ36, ɵ4, ɵ5, ɵ6, ɵ7, ɵ8, ɵ9, LyWithClass as ɵa };
