(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ly = global.ly || {}, global.ly.avatar = {}), global.ng.core, global.ly.core));
    ...
    ***************************************************************************** */
    ...
    var LyAvatar = /** @class */ (function (_super) {
        ...
        function LyAvatar(theme, renderer, _elementRef, sRenderer, _defaults) {
        ...
        Object.defineProperty(LyAvatar.prototype, "size", {
            ...
            set: function (val) {
                if (val !== this.size) {
                    this._size = val;
                    this[0x1] = this.sRenderer.add(LyAvatar.и + "-size-" + val, function () { return (function (className) { return className + "{width:" + val + "px;height:" + val + "px;}"; }); }, STYLE_PRIORITY, this[0x1]);
