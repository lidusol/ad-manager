(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@alyle/ui/badge', ['@angular/core','@alyle/ui','exports', '@angular/core', '@alyle/ui'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,(global.ly = global.ly || {}, global.ly.badge = {}), global.ng.core, global.ly.core));
    ...
    ***************************************************************************** */
    ...
    var LyBadge = /** @class */ (function (_super) {
            ...
            set: function (val) {
                ...
                if (val !== this.overlap) {
                    ...
                    Promise.resolve(null).then(function () {
                        ...
                        var newClass = _this._theme.renderStyle(LyBadge.и + "-overlap-" + val + "&" + hp + "&" + vp, function (theme) {
                            var p = overlap === 'circle'
                                ? 14 : 0;
                            return function (className) { return className + "{" + theme.getDirection(vp) + ":" + p + "%;" + theme.getDirection(hp) + ":" + p + "%;}"; };
                        }, STYLE_PRIORITY);
                        _this._overlapClass = _this._sRenderer.updateClass(newClass, _this._overlapClass);
                    });
                }
            },
            enumerable: false,
        ...
        Object.defineProperty(LyBadge.prototype, "lyBadgeBg", {
            ...
            set: function (val) {
                ...
                if (val !== this.lyBadgeBg) {
                    this._lyBadgeBg = val;
                    var newClass_1 = this._theme.renderStyle(LyBadge.и + "--bg-" + val, function (theme) { return function (className) { return className + "{background-color:" + theme.colorOf(val) + ";color:" + theme.colorOf(val + ":contrast") + ";}"; }; }, STYLE_PRIORITY);
                    Promise.resolve(null).then(function () {
                        _this[0x1] = _this._sRenderer.updateClass(newClass_1, _this[0x1]);
                    });
                }
            },
            enumerable: false,
        ...
        Object.defineProperty(LyBadge.prototype, "lyBadgeAppearance", {
            ...
            set: function (val) {
                ...
                if (val !== this.appearance) {
                    ...
                    var styleID_1 = LyBadge.и + "--appearance-" + val;
                    ...
                    Promise.resolve(null).then(function () {
                        _this._appearanceClass = _this._sRenderer.updateClass(newClass_2, _this._appearanceClass);
                    });
                }
            },
            enumerable: false,
        ...
        LyBadge.prototype.ngOnChanges = function () {
            ...
            if (!this._sRenderer) {
                this._sRenderer = new ui.StyleRenderer(this._theme, this._el, this._renderer);
            }
        };
        ...
        LyBadge.prototype._updatePosition = function () {
            ...
            if (hp && vp) {
                ...
                var newClass_3 = this._theme.renderStyle(LyBadge.и + "--position-" + hp + "-" + vp, function (theme) { return function (className) { return className + "{transform:translate(" + (theme.after === 'right'
                    ? x_1 : -x_1) + "%, " + y_1 + "%);}"; }; }, STYLE_PRIORITY);
                Promise.resolve(null).then(function () {
                    _this._positionClass = _this._sRenderer.updateClass(newClass_3, _this._positionClass);
                });
            }
        };
        LyBadge.prototype._createBadge = function () {
            if (!this._badgeEl) {
                ...
                this._sRenderer = new ui.StyleRenderer(this._theme, new core.ElementRef(badge), this._renderer);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyBadge, [{
    ...
    LyBadge.propDecorators = {
        ...
        hPosition: [{ type: core.Input }],
        vPosition: [{ type: core.Input }],
        overlap: [{ type: core.Input }],
        bg: [{ type: core.Input }],
        lyBadgeBg: [{ type: core.Input }],
        appearance: [{ type: core.Input }],
        lyBadgeAppearance: [{ type: core.Input }]
    };

    var LyBadgeModule = /** @class */ (function () {
        function LyBadgeModule() {
        }
LyBadgeModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyBadgeModule });
LyBadgeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyBadgeModule_Factory(t) { return new (t || LyBadgeModule)(); }, imports: [ɵngcc1.LyCommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyBadgeModule, { declarations: [LyBadge], exports: [LyBadge, ɵngcc1.LyCommonModule] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyBadgeModule, [{
        type: core.NgModule,
        args: [{
