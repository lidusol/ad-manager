(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/cdk/platform'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@alyle/ui'), require('@angular/cdk/platform')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/card', ['@angular/core','@alyle/ui','@angular/cdk/platform','@angular/common','exports', '@angular/core', '@angular/common', '@alyle/ui', '@angular/cdk/platform'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.cdk.platform,global.ng.common,(global.ly = global.ly || {}, global.ly.card = {}), global.ng.core, global.ng.common, global.ly.core, global.ng.cdk.platform));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, core, common, ui, platform) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var STYLES = function (theme, ref) {
        ...
        return {
            ...
            content: function (className) { return className + "{display:block;padding:16px 24px;}@media " + theme.breakpoints['XSmall'] + "{" + className + "{padding:16px 16px;}}"; },
            actions: function (className) { return className + "{display:block;padding:8px 12px;}@media " + theme.breakpoints['XSmall'] + "{" + className + "{padding:8px 4px;}}"; },
    ...
    var LyCardBase = /** @class */ (function () {
        function LyCardBase(_theme, _ngZone, _platform) {
            this._theme = _theme;
    ...
    var LyCard = /** @class */ (function (_super) {
        ...
        function LyCard(theme, _el, renderer, ngZone, platform) {
...
LyCard.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LyCard, selectors: [["ly-card"]], inputs: { bg: "bg", color: "color", raised: "raised", outlined: "outlined", elevation: "elevation", shadowColor: "shadowColor", disableRipple: "disableRipple" }, features: [ɵngcc0.ɵɵProvidersFeature([ui.StyleRenderer]), ɵngcc0.ɵɵInheritDefinitionFeature, ɵngcc0.ɵɵNgOnChangesFeature] });
    ...
    var LyCardMedia = /** @class */ (function () {
        ...
        Object.defineProperty(LyCardMedia.prototype, "ratio", {
            ...
            set: function (val) {
                if (val !== this.ratio) {
                    this._ratio = val;
                    this[0x2] = this.sRenderer.add(LyCardMedia.и + "--ratio-" + val, function () { return function (className) { return className + "::before{content:'';display:block;padding-top:" + val
                        .split(':')
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyCardModule, { declarations: [LyCard,
        LyCardContent,
        LyCardActions,
        LyCardMedia], imports: [ɵngcc3.CommonModule], exports: [LyCard,
        LyCardContent,
        LyCardActions,
        LyCardMedia, ɵngcc1.LyCommonModule] }); })();
