(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/cdk/platform'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@alyle/ui'), require('@angular/forms'), require('@angular/cdk/platform')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/checkbox', ['@angular/core','@alyle/ui','@angular/cdk/platform','@angular/common','exports', '@angular/core', '@angular/common', '@alyle/ui', '@angular/forms', '@angular/cdk/platform'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.cdk.platform,global.ng.common,(global.ly = global.ly || {}, global.ly.checkbox = {}), global.ng.core, global.ng.common, global.ly.core, global.ng.forms, global.ng.cdk.platform));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, core, common, ui, forms, platform) { 
var _c0 = ["innerContainer"];
var _c1 = ["input"];
var _c2 = ["*"];
'use strict';
    ...
    ***************************************************************************** */
    ...
    var STYLES = function (theme, ref) {
        ...
        return {
            ...
            root: function () { return function (className) { return className + "{display:inline-flex;-webkit-tap-highlight-color:transparent;}" + ui.st2c(((theme.checkbox
                && theme.checkbox.root
            ...
            layout: function () { return function (className) { return className + "{display:inline-flex;align-items:baseline;cursor:pointer;user-select:none;white-space:nowrap;}" + className + " " + checkbox.label + "{user-select:auto;}"; }; },
            ...
            label: function (className) { return className + "{line-height:24px;}"; },
    ...
    var LyCheckboxBase = /** @class */ (function () {
        function LyCheckboxBase(_theme, _ngZone, _platform) {
            this._theme = _theme;
    ...
    var LyCheckbox = /** @class */ (function (_super) {
        ...
        function LyCheckbox(_commonStyles, _theme, _el, _renderer, _changeDetectorRef, _focusState, sRenderer, ngZone, platform) {
            var _this = _super.call(this, _theme, ngZone, platform) || this;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyCheckbox, [{
    ...
    }], function () { return [{ type: ɵngcc1.LyCoreStyles }, { type: ɵngcc1.LyTheme2 }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ChangeDetectorRef }, { type: ɵngcc1.LyFocusState }, { type: ɵngcc1.StyleRenderer }, { type: ɵngcc0.NgZone }, { type: ɵngcc2.Platform }]; }, { checked: [{
            type: core.Input
        }], required: [{
            type: core.Input
        }], disabled: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyCheckboxModule, { declarations: [LyCheckbox], imports: [ɵngcc3.CommonModule, ɵngcc1.LyCommonModule], exports: [ɵngcc1.LyCommonModule, LyCheckbox] }); })();
