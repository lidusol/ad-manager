(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@alyle/ui/grid', ['@angular/core','@alyle/ui','exports', '@angular/core', '@alyle/ui'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,(global.ly = global.ly || {}, global.ly.grid = {}), global.ng.core, global.ly.core));
    ...
    var LyGridItem = /** @class */ (function () {
        ...
        Object.defineProperty(LyGridItem.prototype, "col", {
            ...
            set: function (val) {
                ...
                this._colClass = this._sr.add(LyGridItem.и + "--col-" + newVal, function (theme) {
...
LyGridModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LyGridModule });
LyGridModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyGridModule_Factory(t) { return new (t || LyGridModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyGridModule, { declarations: [LyGrid,
        LyGridItem], exports: [LyGrid,
        LyGridItem] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyGridModule, [{
        type: core.NgModule,
        args: [{
