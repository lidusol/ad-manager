(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@alyle/ui'), require('@angular/common/http'), require('@angular/common'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/cdk/platform')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/icon', ['exports', '@angular/core', '@alyle/ui', '@angular/common/http', '@angular/common', 'rxjs/operators', '@angular/platform-browser', '@angular/cdk/platform'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.ly = global.ly || {}, global.ly.icon = {}), global.ng.core, global.ly.core, global.ng.common.http, global.ng.common, global.rxjs.operators, global.ng.platformBrowser, global.ng.cdk.platform));
}(this, (function (exports, i0, i4, i1, i3, operators, i2, platform) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var STYLES = function (theme) {
        var loading = i4.keyframesUniqueId.next();
        ...
        return {
            ...
            root: function () { return function (className) { return className + "{font-size:" + theme.icon.fontSize + ";width:1em;position:relative;height:1em;display:inline-flex;-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;}"; }; },
    ...
    var LyIcon = /** @class */ (function (_super) {
        ...
        function LyIcon(iconService, _el, _renderer, theme, sRenderer, _platform) {
