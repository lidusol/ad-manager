(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/cdk/scrolling'),require('@angular/common'),exports, require('@angular/core'), require('@alyle/ui'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@angular/common'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/image-cropper', ['@angular/core','@alyle/ui','@angular/cdk/scrolling','@angular/common','exports', '@angular/core', '@alyle/ui', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@angular/common', '@angular/cdk/scrolling'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.cdk.scrolling,global.ng.common,(global.ly = global.ly || {}, global.ly['image-Cropper'] = {}), global.ng.core, global.ly.core, global.rxjs, global.rxjs.operators, global.ng.cdk.platform, global.ng.common, global.ng.cdk.scrolling));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, core, ui, rxjs, operators, platform, common, scrolling) { 
var _c0 = ["_imgContainer"];
var _c1 = ["_area"];
var _c2 = ["_imgCanvas"];
var _c3 = function (a0, a1) { return { width: a0, height: a1 }; };
...
function LyImageCropper_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("change", function LyImageCropper_ng_template_5_Template_input_change_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r8); var ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.selectInputEvent($event); });
    ɵngcc0.ɵɵelementEnd();
...
LyImageCropper.ɵfac = function LyImageCropper_Factory(t) { return new (t || LyImageCropper)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.StyleRenderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.ViewportRuler)); };
LyImageCropper.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: LyImageCropper, selectors: [["ly-img-cropper"], ["ly-image-cropper"]], viewQuery: function LyImageCropper_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { config: "config", scale: "scale", maxFileSize: "maxFileSize" }, outputs: { scaleChange: "scaleChange", minScaleChange: "minScale", maxScaleChange: "maxScale", loaded: "loaded", imageLoaded: "imageLoaded", ready: "ready", cropped: "cropped", cleaned: "cleaned", error: "error" }, features: [ɵngcc0.ɵɵProvidersFeature([
            ui.StyleRenderer
    ...
    } }, directives: function () { return [ɵngcc3.NgIf, LyCropperArea, ɵngcc3.NgStyle]; }, encapsulation: 2, changeDetection: 0 });
...
LyCropperArea.ɵfac = function LyCropperArea_Factory(t) { return new (t || LyCropperArea)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.StyleRenderer), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(LyImageCropper), ɵngcc0.ɵɵdirectiveInject(common.DOCUMENT)); };
...
LyImageCropperModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyImageCropperModule_Factory(t) { return new (t || LyImageCropperModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyImageCropperModule, { declarations: [LyImageCropper,
        LyCropperArea], imports: [ɵngcc3.CommonModule], exports: [LyImageCropper] }); })();
