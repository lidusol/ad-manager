(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/cdk/platform'),require('@angular/common'),exports, require('@angular/core'), require('@alyle/ui'), require('@alyle/ui/avatar'), require('@angular/cdk/platform'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/list', ['@angular/core','@alyle/ui','@angular/cdk/platform','@angular/common','exports', '@angular/core', '@alyle/ui', '@alyle/ui/avatar', '@angular/cdk/platform', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.cdk.platform,global.ng.common,(global.ly = global.ly || {}, global.ly.list = {}), global.ng.core, global.ly.core, global.ly.avatar, global.ng.cdk.platform, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, core, ui, avatar, platform, common) { 
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyList, [{
    ...
    var LyListItemBase = /** @class */ (function () {
        function LyListItemBase(_theme, _ngZone, _platform) {
            this._theme = _theme;
    ...
    var LyListItem = /** @class */ (function (_super) {
        ...
        function LyListItem(_el, _renderer, theme, ngZone, _rippleService, _focusState, _list, _cd, _platform) {
            var _this = _super.call(this, theme, ngZone, _platform) || this;
            _this._el = _el;
...
LyListItem.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: LyListItem, selectors: [["ly-list-item"], ["a", "ly-list-item", ""], ["button", "ly-list-item", ""]], contentQueries: function LyListItem_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵcontentQuery(dirIndex, avatar.LyAvatar, true);
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyListItem, [{
        ...
        args: [{
            ...
            args: [core.forwardRef(function () { return LyLine; })]
        }], _icon: [{
            type: core.ContentChild,
            args: [core.forwardRef(function () { return LyListIcon; })]
        }], _avatar: [{
            type: core.ContentChild,
            args: [avatar.LyAvatar]
        }] }); })();
        return LyListItem;
    }(LyListItemMixinBase));
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyListModule, { declarations: [LyList,
        LyListItem,
        LyListIcon,
        LyLine], imports: [ɵngcc3.CommonModule], exports: [ɵngcc1.LyCommonModule, LyList,
        LyListItem,
        LyListIcon,
        LyLine] }); })();
