(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/common'),exports, require('@angular/core'), require('@alyle/ui'), require('@angular/forms'), require('rxjs'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/slider', ['@angular/core','@alyle/ui','@angular/common','exports', '@angular/core', '@alyle/ui', '@angular/forms', 'rxjs', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.common,(global.ly = global.ly || {}, global.ly.slider = {}), global.ng.core, global.ly.core, global.ng.forms, global.rxjs, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, ui, forms, rxjs, common) { 
var _c0 = ["bg"];
var _c1 = ["track"];
var _c2 = ["ticksRef"];
var _c3 = ["thumbsRef"];
...
function LySlider_div_9_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    var thumb_r11 = ɵngcc0.ɵɵnextContext().$implicit;
...
function LySlider_div_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("focus", function LySlider_div_9_Template_div_focus_2_listener() { ɵngcc0.ɵɵrestoreView(_r16); var thumb_r11 = ctx.$implicit; var ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15._onFocus(thumb_r11); })("blur", function LySlider_div_9_Template_div_blur_2_listener() { ɵngcc0.ɵɵrestoreView(_r16); var thumb_r11 = ctx.$implicit; var ctx_r17 = ɵngcc0.ɵɵnextContext(); return ctx_r17._onBlur(thumb_r11); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(4, LySlider_div_9_div_4_Template, 3, 3, "div", 12);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var thumb_r11 = ctx.$implicit;
    ...
    ***************************************************************************** */
    ...
    var STYLES = function (theme, ref) {
        ...
        return {
            ...
            root: function () { return function (className) { return className + "{display:inline-block;position:relative;box-sizing:border-box;cursor:pointer;}" + ui.st2c(((theme.slider
                && theme.slider.root
                && (theme.slider.root instanceof ui.StyleCollection
                    ? theme.slider.root.setTransformer(function (fn) { return fn(__); }).css
                    : theme.slider.root(__)))), "" + className) + ui.st2c((ui.LY_COMMON_STYLES.fill), className + " " + __.bg) + className + " " + __.bg + "{margin:auto;}" + className + __.thumbVisible + " " + __.thumb + "," + className + ":not(" + __.thumbNotVisible + "):not(" + __.disabled + ") " + __.thumbContent + ":hover " + __.thumb + "," + className + ":not(" + __.thumbNotVisible + ") " + __.thumbContent + __.thumbContentFocused + " " + __.thumb + "{border-radius:50% 50% 0%;}" + className + __.thumbVisible + " " + __.thumbContent + "::before," + className + ":not(" + __.thumbNotVisible + "):not(" + __.disabled + ") " + __.thumbContent + ":hover::before," + className + ":not(" + __.thumbNotVisible + ") " + __.thumbContent + __.thumbContentFocused + "::before{transform:scale(1);}"; }; },
    ...
    var LySlider = /** @class */ (function () {
        ...
        function LySlider(_theme, _el, _renderer, _cd, sRenderer, _sr, _default) {
            this._theme = _theme;
            this._el = _el;
        ...
        Object.defineProperty(LySlider.prototype, "appearance", {
            ...
            set: function (val) {
                if (val !== this.appearance) {
                    ...
                    this._appearanceClass = this._sr.add(LySlider.и + ".appearance:" + val, function (theme, ref) {
        ...
        Object.defineProperty(LySlider.prototype, "color", {
            ...
            set: function (val) {
                this._color = val;
                var styleKey = LySlider.и + ".color:" + val;
            ...
            set: function (val) {
                ...
                if (newVal !== this.disabled) {
                    ...
                    if (newVal) {
                        ...
                        var styleKey = LySlider.и + ".disabled:" + val + "-" + color_1;
                        var newStyle = void 0;
        ...
        LySlider.prototype._startSlide = function () {
            if (!this._isSliding) {
                ...
                this._thumbsOnSlideStart = this._thumbs.slice(0).map(function (t) { return (Object.assign({}, t)); });
...
LySlider.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: LySlider, selectors: [["ly-slider"]], viewQuery: function LySlider_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { thumbVisible: "thumbVisible", marks: "marks", max: "max", min: "min", appearance: "appearance", color: "color", vertical: "vertical", step: "step", value: "value", disabled: "disabled", ticks: "ticks", displayWith: "displayWith" }, outputs: { change: "change", input: "input", valueChange: "valueChange" }, exportAs: ["lySlider"], features: [ɵngcc0.ɵɵProvidersFeature([
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LySlider, [{
    ...
    LySlider.propDecorators = {
        ...
        _bg: [{ type: core.ViewChild, args: ['bg',] }],
        _track: [{ type: core.ViewChild, args: ['track', { static: true },] }],
        _ticksRef: [{ type: core.ViewChild, args: ['ticksRef', { static: true },] }],
        _thumbsRef: [{ type: core.ViewChildren, args: ['thumbsRef',] }],
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LyMark, [{
    ...
    LyMark.propDecorators = {
        _tick: [{ type: core.ViewChild, args: [LyTick, { static: true },] }],
        value: [{ type: core.Input }]
    };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LySliderModule, { declarations: [LySlider,
        LyMark,
        LyTick], imports: [ɵngcc2.CommonModule, ɵngcc1.LyCommonModule], exports: [LySlider,
        LyMark] }); })();
