(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),exports, require('@angular/core'), require('@alyle/ui'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/snack-bar', ['@angular/core','@alyle/ui','exports', '@angular/core', '@alyle/ui', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,(global.ly = global.ly || {}, global.ly['snack-Bar'] = {}), global.ng.core, global.ly.core, global.rxjs));
}(this, (function (ɵngcc0,ɵngcc1,exports, i0, ui, rxjs) { 'use strict';

    var LySnackBarService = /** @class */ (function () {
        function LySnackBarService() {
        }
LySnackBarService.ɵfac = function LySnackBarService_Factory(t) { return new (t || LySnackBarService)(); };
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LySnackBarService, [{
        type: i0.Injectable,
        args: [{
                providedIn: 'root'
            }]
...
LySnackBarModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: LySnackBarModule });
LySnackBarModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LySnackBarModule_Factory(t) { return new (t || LySnackBarModule)(); }, imports: [[ui.LyOverlayModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LySnackBarModule, { declarations: [LySnackBar], imports: [ɵngcc1.LyOverlayModule], exports: [LySnackBar] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(LySnackBarModule, [{
        type: i0.NgModule,
        args: [{
