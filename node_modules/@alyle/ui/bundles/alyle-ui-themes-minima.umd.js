(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@alyle/ui'), require('@alyle/ui/responsive'), require('@angular/core'), require('@alyle/ui/color')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/themes/minima', ['@angular/core','exports', '@alyle/ui', '@alyle/ui/responsive', '@angular/core', '@alyle/ui/color'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.ly = global.ly || {}, global.ly['themes/Minima'] = {}), global.ly.core, global.ly.responsive, global.ng.core, global.ly.color));
}(this, (function (ɵngcc0,exports, ui, responsive, core, color) { 'use strict';
...
MinimaBase.ɵfac = function MinimaBase_Factory(t) { return new (t || MinimaBase)(); };
MinimaBase.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaBase, factory: function (t) { return MinimaBase.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MinimaBase, [{
        type: core.Injectable
    }], function () { return []; }, null); })();
        return MinimaBase;
    }(ui.LyStyleUtils));
    MinimaBase.ctorParameters = function () { return []; };

    var ThemeMinimaLight = /** @class */ (function () {
        function ThemeMinimaLight() {
        }
ThemeMinimaLight.ɵfac = function ThemeMinimaLight_Factory(t) { return new (t || ThemeMinimaLight)(); };
ThemeMinimaLight.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ThemeMinimaLight, selectors: [["", "ly-theme-minima-light", ""]], features: [ɵngcc0.ɵɵProvidersFeature([ui.LyTheme2, { provide: ui.LY_THEME_NAME, useValue: 'minima-light' }])] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThemeMinimaLight, [{
        type: core.Directive,
        args: [{
...
ThemeMinimaDark.ɵfac = function ThemeMinimaDark_Factory(t) { return new (t || ThemeMinimaDark)(); };
ThemeMinimaDark.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ThemeMinimaDark, selectors: [["", "ly-theme-minima-dark", ""]], features: [ɵngcc0.ɵɵProvidersFeature([ui.LyTheme2, { provide: ui.LY_THEME_NAME, useValue: 'minima-dark' }])] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThemeMinimaDark, [{
        type: core.Directive,
        args: [{
...
ThemeMinimaModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ThemeMinimaModule });
ThemeMinimaModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function ThemeMinimaModule_Factory(t) { return new (t || ThemeMinimaModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ThemeMinimaModule, { declarations: [ThemeMinimaDark,
        ThemeMinimaLight], exports: [ThemeMinimaDark,
        ThemeMinimaLight] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ThemeMinimaModule, [{
        type: core.NgModule,
        args: [{
    ...
    ThemeMinimaModule.ctorParameters = function () { return []; };
    ...
    var MinimaLight = /** @class */ (function (_super) {
        ...
        function MinimaLight() {
            ...
            _this.disabled = {
                default: new color.Color(0, 0, 0, 0.12),
                contrast: new color.Color(0, 0, 0, 0.26)
            };
            _this.text = {
            ...
            _this.field = ui.mergeThemes(_this.field, {
                root: new ui.StyleCollection(function (_a) {
            ...
            _this.menu = {
                root: new ui.StyleCollection(function (__) { return function (className) { return className + " " + __.item + " ly-icon," + className + " " + __.itemSubMenuTrigger + ":after{color:" + color.color(0, 0, 0, 0.54) + ";}"; }; })
            };
            return _this;
        }
MinimaLight.ɵfac = function MinimaLight_Factory(t) { return new (t || MinimaLight)(); };
MinimaLight.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaLight, factory: function (t) { return MinimaLight.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MinimaLight, [{
    ...
    var MinimaDark = /** @class */ (function (_super) {
        ...
        function MinimaDark() {
            ...
            _this.field = ui.mergeThemes(_this.field, {
                root: new ui.StyleCollection(function (_) { return function (className) { return className + " " + _.container + ":after," + className + " " + _.fieldset + "," + className + " " + _.labelContainer + "{border-color:" + new color.Color(255, 255, 255, 0.12) + ";}" + className + " " + _.label + "," + className + " " + _.placeholder + "{color:" + new color.Color(255, 255, 255, 0.4) + ";}"; }; }),
                appearance: {
            ...
            _this.menu = {
                root: new ui.StyleCollection(function (__) { return function (className) { return className + " " + __.item + " ly-icon," + className + " " + __.itemSubMenuTrigger + ":after{color:" + color.color(0xffffff) + ";}"; }; })
            };
            return _this;
        }
MinimaDark.ɵfac = function MinimaDark_Factory(t) { return new (t || MinimaDark)(); };
MinimaDark.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaDark, factory: function (t) { return MinimaDark.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MinimaDark, [{
    ...
    var MinimaDeepDark = /** @class */ (function (_super) {
        ...
        function MinimaDeepDark() {
            ...
            _this.background = {
                default: new color.Color(24, 24, 24),
                primary: {
                    default: new color.Color(16, 16, 16),
                    shadow: shadow$2
                },
                secondary: new color.Color(24, 24, 24),
                tertiary: new color.Color(32, 32, 32),
            };
            _this.paper = {
                default: new color.Color(16, 16, 16),
                shadow: shadow$2
...
MinimaDeepDark.ɵfac = function MinimaDeepDark_Factory(t) { return new (t || MinimaDeepDark)(); };
MinimaDeepDark.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: MinimaDeepDark, factory: function (t) { return MinimaDeepDark.ɵfac(t); } });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MinimaDeepDark, [{
        type: core.Injectable
    }], function () { return []; }, null); })();
