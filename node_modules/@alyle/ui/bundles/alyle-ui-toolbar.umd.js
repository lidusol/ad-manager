(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@alyle/ui'),require('@angular/common'),exports, require('@angular/core'), require('@alyle/ui'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@alyle/ui/toolbar', ['@angular/core','@alyle/ui','@angular/common','exports', '@angular/core', '@alyle/ui', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,global.ng.common,(global.ly = global.ly || {}, global.ly.toolbar = {}), global.ng.core, global.ly.core, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, ui, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LyToolbar = /** @class */ (function (_super) {
        ...
        function LyToolbar(_renderer, _el, theme, sRenderer) {
        ...
        Object.defineProperty(LyToolbar.prototype, "appearance", {
            ...
            set: function (val) {
                if (val !== this.appearance) {
                    ...
                    this._appearanceClass = this.sRenderer.add("LyToolbar.appearance:" + val, function (theme, ref) {
...
LyToolbarModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyToolbarModule_Factory(t) { return new (t || LyToolbarModule)(); }, imports: [[common.CommonModule, ui.LyCommonModule], ɵngcc1.LyCommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyToolbarModule, { declarations: [LyToolbar], imports: [ɵngcc2.CommonModule, ɵngcc1.LyCommonModule], exports: [LyToolbar, ɵngcc1.LyCommonModule] }); })();
