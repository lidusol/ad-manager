(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@alyle/ui/typography', ['@angular/core','@alyle/ui','exports', '@angular/core', '@alyle/ui'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.alyle.ui,(global.ly = global.ly || {}, global.ly.typography = {}), global.ng.core, global.ly.core));
    ...
    ***************************************************************************** */
    ...
    var LyTypography = /** @class */ (function (_super) {
        ...
        function LyTypography(_theme, _el, renderer, sRenderer) {
        ...
        LyTypography.prototype._createTypClass = function (val, instance) {
            ...
            return this.sRenderer.add(newKey, function (theme) {
                if (theme.typography && theme.typography.lyTyp) {
                    var lyTyp = theme.typography.lyTyp[val];
                    if (lyTyp) {
                        return lyTyp instanceof ui.StyleCollection
...
LyTypographyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function LyTypographyModule_Factory(t) { return new (t || LyTypographyModule)(); }, imports: [ɵngcc1.LyCommonModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(LyTypographyModule, { declarations: [LyTypography], exports: [LyTypography, ɵngcc1.LyCommonModule] }); })();
