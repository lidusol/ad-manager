(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/cdk/a11y'),require('@angular/cdk/overlay'),require('@angular/cdk/bidi'),exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/overlay'), require('@angular/cdk/coercion'), require('@angular/cdk/keycodes'), require('@angular/animations'), require('@angular/cdk/a11y'), require('@angular/cdk/bidi'), require('@angular/cdk/portal')) :
    typeof define === 'function' && define.amd ? define('@material-extended/mde', ['@angular/core','@angular/common','@angular/cdk/a11y','@angular/cdk/overlay','@angular/cdk/bidi','exports', '@angular/core', '@angular/common', '@angular/cdk/overlay', '@angular/cdk/coercion', '@angular/cdk/keycodes', '@angular/animations', '@angular/cdk/a11y', '@angular/cdk/bidi', '@angular/cdk/portal'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.cdk.a11y,global.ng.cdk.overlay,global.ng.cdk.bidi,(global['material-extended'] = global['material-extended'] || {}, global['material-extended'].mde = {}), global.ng.core, global.ng.common, global.ng.cdk.overlay, global.ng.cdk.coercion, global.ng.cdk.keycodes, global.ng.animations, global.ng.cdk.a11y, global.ng.cdk.bidi, global.ng.cdk.portal));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, core, common, overlay, coercion, keycodes, animations, a11y, bidi, portal) { 
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MdePopover, [{
    ...
    var MdePopoverTrigger = /** @class */ (function () {
        ...
        */
        ...
        MdePopoverTrigger = __decorate([ __param(3, core.Optional())
        ], MdePopoverTrigger);
MdePopoverTrigger.ɵfac = function MdePopoverTrigger_Factory(t) { return new (t || MdePopoverTrigger)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.Overlay), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MdePopoverTrigger, [{
    ...
    }], function () { return [{ type: ɵngcc3.Overlay }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc4.Directionality, decorators: [{
                type: core.Optional
...
MdePopoverTarget.ɵfac = function MdePopoverTarget_Factory(t) { return new (t || MdePopoverTarget)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
MdePopoverTarget.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: MdePopoverTarget, selectors: [["mde-popover-target"], ["", "mdePopoverTarget", ""]], exportAs: ["mdePopoverTarget"] });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(MdePopoverTarget, [{
        type: core.Directive,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MdePopoverModule, { declarations: [MdePopover,
        MdePopoverTrigger,
        MdePopoverTarget], imports: [ɵngcc3.OverlayModule, ɵngcc1.CommonModule, ɵngcc2.A11yModule], exports: [MdePopover,
        MdePopoverTrigger,
        MdePopoverTarget] }); })();
