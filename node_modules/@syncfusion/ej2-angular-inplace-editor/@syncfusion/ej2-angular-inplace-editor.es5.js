...
InPlaceEditorComponent.ɵfac = function InPlaceEditorComponent_Factory(t) { return new (t || InPlaceEditorComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Injector)); };
InPlaceEditorComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: InPlaceEditorComponent, selectors: [["ejs-inplaceeditor"]], contentQueries: function InPlaceEditorComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, _c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.template = _t.first);
    } }, inputs: { actionOnBlur: "actionOnBlur", adaptor: "adaptor", cancelButton: "cancelButton", cssClass: "cssClass", disabled: "disabled", editableOn: "editableOn", emptyText: "emptyText", enableEditMode: "enableEditMode", enableHtmlSanitizer: "enableHtmlSanitizer", enablePersistence: "enablePersistence", enableRtl: "enableRtl", locale: "locale", mode: "mode", model: "model", name: "name", popupSettings: "popupSettings", primaryKey: "primaryKey", saveButton: "saveButton", showButtons: "showButtons", submitOnEnter: "submitOnEnter", template: "template", textOption: "textOption", type: "type", url: "url", validationRules: "validationRules", value: "value" }, outputs: { focus: "focus", blur: "blur", actionBegin: "actionBegin", actionFailure: "actionFailure", actionSuccess: "actionSuccess", beforeSanitizeHtml: "beforeSanitizeHtml", beginEdit: "beginEdit", created: "created", destroyed: "destroyed", validating: "validating" }, features: [ɵngcc0.ɵɵProvidersFeature([
            {
                provide: NG_VALUE_ACCESSOR,
                useExisting: forwardRef(function () { return InPlaceEditorComponent_1; }),
                multi: true
            }
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function InPlaceEditorComponent_Template(rf, ctx) { }, encapsulation: 2, changeDetection: 0 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InPlaceEditorComponent, [{
        type: Component,
        args: [{
...
InPlaceEditorModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: InPlaceEditorModule });
InPlaceEditorModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function InPlaceEditorModule_Factory(t) { return new (t || InPlaceEditorModule)(); }, imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(InPlaceEditorModule, { declarations: function () { return [InPlaceEditorComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [InPlaceEditorComponent]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InPlaceEditorModule, [{
        type: NgModule,
        args: [{
...
InPlaceEditorAllModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: InPlaceEditorAllModule });
InPlaceEditorAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function InPlaceEditorAllModule_Factory(t) { return new (t || InPlaceEditorAllModule)(); }, providers: [
        AutoCompleteService,
        ColorPickerService,
        ComboBoxService,
        ...
        InPlaceEditorModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(InPlaceEditorAllModule, { imports: function () { return [CommonModule,
        InPlaceEditorModule]; }, exports: function () { return [InPlaceEditorModule]; } }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(InPlaceEditorAllModule, [{
        type: NgModule,
        args: [{
                imports: [CommonModule, InPlaceEditorModule],
                exports: [
