...
PivotFieldListComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PivotFieldListComponent, selectors: [["ejs-pivotfieldlist"]], inputs: { allowCalculatedField: "allowCalculatedField", allowDeferLayoutUpdate: "allowDeferLayoutUpdate", cssClass: "cssClass", dataSourceSettings: "dataSourceSettings", enablePersistence: "enablePersistence", enableRtl: "enableRtl", loadOnDemandInMemberEditor: "loadOnDemandInMemberEditor", locale: "locale", maxNodeLimitInMemberEditor: "maxNodeLimitInMemberEditor", renderMode: "renderMode", showValuesButton: "showValuesButton", spinnerTemplate: "spinnerTemplate", target: "target" }, outputs: { aggregateCellInfo: "aggregateCellInfo", created: "created", dataBound: "dataBound", destroyed: "destroyed", enginePopulated: "enginePopulated", enginePopulating: "enginePopulating", fieldDrop: "fieldDrop", load: "load", memberFiltering: "memberFiltering", onFieldDropped: "onFieldDropped" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 0, vars: 0, template: function PivotFieldListComponent_Template(rf, ctx) { }, encapsulation: 2, changeDetection: 0 });
/**
 * @nocollapse
 */
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PivotViewAllModule, { imports: function () { return [CommonModule,
        PivotViewModule]; }, exports: function () { return [PivotViewModule]; } }); })();
...
PivotFieldListAllModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PivotFieldListAllModule_Factory(t) { return new (t || PivotFieldListAllModule)(); }, providers: [], imports: [[CommonModule, PivotFieldListModule],
        PivotFieldListModule] });
/**
 * @nocollapse
 */
PivotFieldListAllModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PivotFieldListAllModule, { imports: function () { return [CommonModule,
        PivotFieldListModule]; }, exports: function () { return [PivotFieldListModule]; } }); })();
