(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('ngx-bootstrap/dropdown'),require('ngx-bootstrap/tooltip'),require('@angular/forms'),exports, require('@angular/core'), require('google-libphonenumber'), require('@angular/forms'), require('ngx-bootstrap/dropdown'), require('ngx-bootstrap/tooltip'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-intl-tel-input', ['@angular/core','@angular/common','ngx-bootstrap/dropdown','ngx-bootstrap/tooltip','@angular/forms','exports', '@angular/core', 'google-libphonenumber', '@angular/forms', 'ngx-bootstrap/dropdown', 'ngx-bootstrap/tooltip', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ngxBootstrap.dropdown,global.ngxBootstrap.tooltip,global.ng.forms,global['ngx-intl-tel-input'] = {}, global.ng.core, global['^3']['2']['1'], global.ng.forms, global.dropdown, global.tooltip, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, core, googleLibphonenumber, forms, dropdown, tooltip, common) { 
var _c0 = ["countryList"];
...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxIntlTelInputService = /** @class */ (function () {
        ...
        NgxIntlTelInputService.ɵprov = core.ɵɵdefineInjectable({ factory: function NgxIntlTelInputService_Factory() { return new NgxIntlTelInputService(); }, token: NgxIntlTelInputService, providedIn: "root" });
        ...
        */
        ...
        NgxIntlTelInputComponent.prototype.onPhoneNumberChange = function () {
            ...
            if (!this.value) {
                ...
                var intlNo = number
                    ? this.phoneUtil.format(number, googleLibphonenumber.PhoneNumberFormat.INTERNATIONAL)
                    : '';
                ...
                this.propagateChange({
                    ...
                    nationalNumber: number
                        ? this.phoneUtil.format(number, googleLibphonenumber.PhoneNumberFormat.NATIONAL)
                        : '',
                    e164Number: number
                        ? this.phoneUtil.format(number, googleLibphonenumber.PhoneNumberFormat.E164)
                        : '',
        ...
        NgxIntlTelInputComponent.prototype.removeDialCode = function (phoneNumber) {
            ...
            phoneNumber = this.phoneUtil.format(number, googleLibphonenumber.PhoneNumberFormat[this.numberFormat]);
        ...
        NgxIntlTelInputComponent.prototype.getPhoneNumberPlaceHolder = function (countryCode) {
            try {
                return this.phoneUtil.format(this.phoneUtil.getExampleNumber(countryCode), googleLibphonenumber.PhoneNumberFormat[this.numberFormat]);
            }
            catch (e) {
                return e;
            }
...
NgxIntlTelInputComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgxIntlTelInputComponent, selectors: [["ngx-intl-tel-input"]], viewQuery: function NgxIntlTelInputComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.countryList = _t.first);
            ...
            CountryCode,
            {
                ...
                useExisting: core.forwardRef(function () { return NgxIntlTelInputComponent_1; }),
                multi: true
            },
            {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NgxIntlTelInputComponent, [{
    ...
    */
    var NativeElementInjectorDirective = /** @class */ (function () {
        ...
        NativeElementInjectorDirective = __decorate([ __metadata("design:paramtypes", [forms.NgControl,
                core.ElementRef])
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NgxIntlTelInputModule, { declarations: [NgxIntlTelInputComponent,
        NativeElementInjectorDirective], imports: [ɵngcc1.CommonModule, ɵngcc4.FormsModule, ɵngcc4.ReactiveFormsModule, ɵngcc2.BsDropdownModule, ɵngcc3.TooltipModule], exports: [NgxIntlTelInputComponent,
        NativeElementInjectorDirective] }); })();
