...
class ImageCompressor {
  ...
  private readerOnloadCallback() {
    return (event: ProgressEvent) => {
        ...
        originalImage.onload = this.imageOnloadCallback(originalImage, event.total);
  }; }

  private imageOnloadCallback(img: HTMLImageElement, lastSize: any) {
    return () => {
