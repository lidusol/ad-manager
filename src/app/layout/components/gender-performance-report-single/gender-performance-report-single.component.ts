...
@Component({
  selector: 'adf-gender-performance-report-single',
  templateUrl: './gender-performance-report-single.component.html',
  styleUrls: ['./gender-performance-report-single.component.scss']
})
export class GenderPerformanceReportSingleComponent implements OnInit {
  ...
  getGendersPerformanceReportData(): Promise<GENDERS_REPORT[]>{
    return new Promise(resolve => {
      this.displayService.checkGendersReportSingle(this.campaignId).then(report=>{
        if(report===null){
        ...
        this.displayService.getGendersPerformanceReportSingle(this.campaignId, startDateFormattedGoogle, endDateFormattedGoogle).then(res => {
          if(res.length>1){
        ...
        if(index===gendersData.length-1){
          ...
          this.gendersReport.forEach((item, y)=>{
            ...
            if(this.gendersReport.length-1===y){
              ...
              this.displayService.saveGendersReportSingle(this.campaignId, this.clicks, this.costs, this.impressions, this.gendersReport, this.googleVisualizeData).then(rep=>{
                /* ////console.log(rep) */
