...
@Component({
  selector: 'adf-cmp-youtube-recap',
  templateUrl: './cmp-youtube-recap.component.html',
    styleUrls: ['./cmp-youtube-recap.component.scss'],
  
})
export class CmpYoutubeRecapComponent implements OnInit {
    @Input() data: Display[] = [];
    isLoading = true
